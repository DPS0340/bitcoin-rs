...
| [indexing.md](indexing.md) | `IDX-01`–`IDX-07` | Index capability gating, watermark identity, query consistency, selective reset, reorg rollback, and error isolation | `crates/node/src/txindex_worker.rs`, `crates/index/src/index.rs`, RPC/Esplora queries | `crates/node/src/txindex_worker_reconcile_tests.rs`, `crates/node/src/txindex_worker_query_tests.rs`, `bin/bitcoin-rs/tests/gates/g10_reorg_deep.rs` |
