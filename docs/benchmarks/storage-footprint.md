...
The measurement exposed this: fjall's 1.601x amplification versus rocksdb's
...
2,525,015 bytes for 200k rows. The eight-byte values are included in the
logical-size and amplification calculations above.
