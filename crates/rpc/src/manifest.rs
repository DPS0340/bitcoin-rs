...
pub const MANIFEST: &[Entry] = &[
    ...
    Entry {
        ...
        feature: "",
        core_version: CORE_VERSION,
        notes: "bitcoin-rs reporting of compiled/enabled concrete service capabilities and index lifecycle state (crates/rpc/src/handlers/chain.rs, crates/node/src/capabilities.rs).",
        since: "0.4.0",
    },
