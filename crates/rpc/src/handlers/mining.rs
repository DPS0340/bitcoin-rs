...
use crate::handlers::{
    ensure_at_most_params, ensure_no_params, optional_bool, params_array, required_str,
    required_u64,
};
...
fn render_mining_info(info: &MiningInfo) -> Result<Value, RpcError> {
    ...
    // See docs/contracts/external-api.md#API-25 for the omission contract.
...
mod tests {
    ...
    fn generateblock_rejects_multipath_before_ranged_like_core() {
        ...
        let wrong_network = generateblock(
            &ctx_with_control_on_network(control, Network::Mainnet),
